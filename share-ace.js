...
(function() {
  var Range, applyToShareJS, cursorToRange, rangeToCursor, suppress,
  ...
  window.sharejs.extendDoc('attach_ace', function(editor, keepEditorContents) {
    var check, cursorListener, doc, docListener, editorDoc, editorListener, offsetToPos, updateCursors;
